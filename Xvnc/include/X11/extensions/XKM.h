/* $XConsortium: XKM.h,v 1.2 94/04/05 15:21:14 erik Exp $ */
/************************************************************
...
#define	XkmAlternateSymsFile	24
...
#define	XkmSemanticsRequired	(XkmTypesMask|XkmCompatMapMask)
#define	XkmSemanticsOptional	(XkmVirtualModsMask|XkmIndicatorsMask)
#define	XkmSemanticsLegal	(XkmSemanticsRequired|XkmSemanticsOptional)
#define	XkmLayoutRequired	(XkmKeyNamesMask|XkmSymbolsMask)
...
#define	XkmKeymapOptional	(XkmSemanticsOptional|XkmLayoutOptional)
